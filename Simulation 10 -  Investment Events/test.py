...
fileIO.write_to_file ("Simulation_results2.csv", data5)
fileIO.write_to_file ("Simulation_results2.csv", data1)
fileIO.write_to_file ("Simulation_results2.csv", data2)
fileIO.write_to_file ("Simulation_results2.csv", data3)
fileIO.write_to_file ("Simulation_results2.csv", data4)
...
plt.legend(title='Status')
    # plt.show()
plt.savefig('Simulated Development Cost2.png')
